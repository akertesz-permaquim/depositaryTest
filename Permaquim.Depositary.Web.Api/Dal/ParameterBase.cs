...
public class WhereParameterBase
{
    ...
    protected string GetOperand(DepositaryWebApi.sqlEnum.OperandEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case DepositaryWebApi.sqlEnum.OperandEnum.Between:
                    return _BETWEEN;
                case DepositaryWebApi.sqlEnum.OperandEnum.Equal:
                    return _EQUAL;
                case DepositaryWebApi.sqlEnum.OperandEnum.GreaterThan:
                    return _GREATER_THAN;
                case DepositaryWebApi.sqlEnum.OperandEnum.GreaterThanOrEqual:
                    return _GREATER_THAN_OR_EQUAL;
                case DepositaryWebApi.sqlEnum.OperandEnum.In:
                    return _IN_;
                case DepositaryWebApi.sqlEnum.OperandEnum.IsNotNull:
                    return _IS_NOT_NULL;
                case DepositaryWebApi.sqlEnum.OperandEnum.IsNull:
                    return _IS_NULL;
                case DepositaryWebApi.sqlEnum.OperandEnum.LessThan:
                    return _LESS_THAN;
                case DepositaryWebApi.sqlEnum.OperandEnum.LessThanOrEqual:
                    return _LESS_THAN_OR_EQUAL;
                case DepositaryWebApi.sqlEnum.OperandEnum.Like:
                    return _LIKE;
                case DepositaryWebApi.sqlEnum.OperandEnum.NotEqual:
                    return _NOT_EQUAL;
                case DepositaryWebApi.sqlEnum.OperandEnum.NotIn:
                    return _NOT_IN;
                case DepositaryWebApi.sqlEnum.OperandEnum.NotLike:
                    return _NOT_LIKE;
            }
            return null;
        }
...
public  class AggregateParameterBase
{
    ...
    protected string GetOperand(DepositaryWebApi.sqlEnum.FunctionEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case DepositaryWebApi.sqlEnum.FunctionEnum.Avg:
                    return _AVG;
                case DepositaryWebApi.sqlEnum.FunctionEnum.Count:
                    return _COUNT;
                case DepositaryWebApi.sqlEnum.FunctionEnum.Max:
                    return _MAX;
                case DepositaryWebApi.sqlEnum.FunctionEnum.Min:
                    return _MIN;
                case DepositaryWebApi.sqlEnum.FunctionEnum.StdDev:
                    return _STDEV;
                case DepositaryWebApi.sqlEnum.FunctionEnum.Sum:
                    return _SUM;
                case DepositaryWebApi.sqlEnum.FunctionEnum.Var:
                    return _VAR;
            }
            return null;
        }
...
public class WhereParameter : WhereParameterBase
{
    ...
    internal void Add(String column, DepositaryWebApi.sqlEnum.OperandEnum operand, dynamic values)
    {
    ...
    internal void Add(DepositaryWebApi.sqlEnum.ConjunctionEnum Conjunction, String column, DepositaryWebApi.sqlEnum.OperandEnum operand, dynamic values)
    {
        string operandString = base.GetOperand(operand);
        List<ParameterItemValue> _values = new List<ParameterItemValue>();
        try
        {
            ...
            switch (operand)
            {
                ...
                case DepositaryWebApi.sqlEnum.OperandEnum.NotIn:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " (" + _buff.Substring(0, _buff.Length - 1) + ")", column, operandString, column, _values));
                    break;
                case DepositaryWebApi.sqlEnum.OperandEnum.IsNull:
                case DepositaryWebApi.sqlEnum.OperandEnum.IsNotNull:
                    _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString, column, operandString, column, _values));
                    break;
                default:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " " + _buff.Substring(0, _buff.Length - 1), column, operandString, column, _values));
    ...
    internal void Add(DepositaryWebApi.sqlEnum.ConjunctionEnum Conjunction, String betweenColumn, object fromValue, object toValue)
    {
        ...
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + firstParameter, fromValue));
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + secondParameter, toValue));
        _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.ConjunctionEnum), Conjunction) + " " + betweenColumn + " BETWEEN " + Constants.INPUT_PARAMETER + firstParameter + " AND " + Constants.INPUT_PARAMETER + secondParameter, betweenColumn, "Between", betweenColumn, _values));
        }
        else
        {
    ...
    internal void AddConjunction(DepositaryWebApi.sqlEnum.ConjunctionEnum Conjunction)
    {
        _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.ConjunctionEnum), Conjunction) + " ", false));
    }
}
public class OrderByParameter : OrderByParameterBase
{
    internal void Add(String Column, DepositaryWebApi.sqlEnum.DirEnum Direction = DepositaryWebApi.sqlEnum.DirEnum.ASC)
    {
        try
        {
            base._orderByParameters.Add(new ParameterItem(Column + " " + Enum.GetName(typeof(DepositaryWebApi.sqlEnum.DirEnum), Direction)));
        }
        catch (Exception ex)
        {
            throw ex;
...
{
    internal void Add(DepositaryWebApi.sqlEnum.FunctionEnum AggregateFunction, String Column)
    {
        try
        {
