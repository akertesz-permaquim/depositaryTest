...
public class WhereParameterBase
{
    ...
    protected string GetOperand(DefaultNamespace.sqlEnum.OperandEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case DefaultNamespace.sqlEnum.OperandEnum.Between:
                    return _BETWEEN;
                case DefaultNamespace.sqlEnum.OperandEnum.Equal:
                    return _EQUAL;
                case DefaultNamespace.sqlEnum.OperandEnum.GreaterThan:
                    return _GREATER_THAN;
                case DefaultNamespace.sqlEnum.OperandEnum.GreaterThanOrEqual:
                    return _GREATER_THAN_OR_EQUAL;
                case DefaultNamespace.sqlEnum.OperandEnum.In:
                    return _IN_;
                case DefaultNamespace.sqlEnum.OperandEnum.IsNotNull:
                    return _IS_NOT_NULL;
                case DefaultNamespace.sqlEnum.OperandEnum.IsNull:
                    return _IS_NULL;
                case DefaultNamespace.sqlEnum.OperandEnum.LessThan:
                    return _LESS_THAN;
                case DefaultNamespace.sqlEnum.OperandEnum.LessThanOrEqual:
                    return _LESS_THAN_OR_EQUAL;
                case DefaultNamespace.sqlEnum.OperandEnum.Like:
                    return _LIKE;
                case DefaultNamespace.sqlEnum.OperandEnum.NotEqual:
                    return _NOT_EQUAL;
                case DefaultNamespace.sqlEnum.OperandEnum.NotIn:
                    return _NOT_IN;
                case DefaultNamespace.sqlEnum.OperandEnum.NotLike:
                    return _NOT_LIKE;
            }
            return null;
        }
...
public  class AggregateParameterBase
{
    ...
    protected string GetOperand(DefaultNamespace.sqlEnum.FunctionEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case DefaultNamespace.sqlEnum.FunctionEnum.Avg:
                    return _AVG;
                case DefaultNamespace.sqlEnum.FunctionEnum.Count:
                    return _COUNT;
                case DefaultNamespace.sqlEnum.FunctionEnum.Max:
                    return _MAX;
                case DefaultNamespace.sqlEnum.FunctionEnum.Min:
                    return _MIN;
                case DefaultNamespace.sqlEnum.FunctionEnum.StdDev:
                    return _STDEV;
                case DefaultNamespace.sqlEnum.FunctionEnum.Sum:
                    return _SUM;
                case DefaultNamespace.sqlEnum.FunctionEnum.Var:
                    return _VAR;
            }
            return null;
        }
...
public class WhereParameter : WhereParameterBase
{
    ...
    internal void Add(String column, DefaultNamespace.sqlEnum.OperandEnum operand, dynamic values)
    {
    ...
    internal void Add(DefaultNamespace.sqlEnum.ConjunctionEnum Conjunction, String column, DefaultNamespace.sqlEnum.OperandEnum operand, dynamic values)
    {
        string operandString = base.GetOperand(operand);
        List<ParameterItemValue> _values = new List<ParameterItemValue>();
        try
        {
            ...
            switch (operand)
            {
                ...
                case DefaultNamespace.sqlEnum.OperandEnum.NotIn:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " (" + _buff.Substring(0, _buff.Length - 1) + ")", column, operandString, column, _values));
                    break;
                case DefaultNamespace.sqlEnum.OperandEnum.IsNull:
                case DefaultNamespace.sqlEnum.OperandEnum.IsNotNull:
                    _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString, column, operandString, column, _values));
                    break;
                default:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " " + _buff.Substring(0, _buff.Length - 1), column, operandString, column, _values));
    ...
    internal void Add(DefaultNamespace.sqlEnum.ConjunctionEnum Conjunction, String betweenColumn, object fromValue, object toValue)
    {
        ...
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + firstParameter, fromValue));
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + secondParameter, toValue));
        _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.ConjunctionEnum), Conjunction) + " " + betweenColumn + " BETWEEN " + Constants.INPUT_PARAMETER + firstParameter + " AND " + Constants.INPUT_PARAMETER + secondParameter, betweenColumn, "Between", betweenColumn, _values));
        }
        else
        {
    ...
    internal void AddConjunction(DefaultNamespace.sqlEnum.ConjunctionEnum Conjunction)
    {
        _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.ConjunctionEnum), Conjunction) + " ", false));
    }
}
public class OrderByParameter : OrderByParameterBase
{
    internal void Add(String Column, DefaultNamespace.sqlEnum.DirEnum Direction = DefaultNamespace.sqlEnum.DirEnum.ASC)
    {
        try
        {
            base._orderByParameters.Add(new ParameterItem(Column + " " + Enum.GetName(typeof(DefaultNamespace.sqlEnum.DirEnum), Direction)));
        }
        catch (Exception ex)
        {
            throw ex;
...
{
    internal void Add(DefaultNamespace.sqlEnum.FunctionEnum AggregateFunction, String Column)
    {
        try
        {
