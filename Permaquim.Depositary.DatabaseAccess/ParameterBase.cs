...
public class WhereParameterBase
{
    ...
    protected string GetOperand(Depositary.sqlEnum.OperandEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case Depositary.sqlEnum.OperandEnum.Between:
                    return _BETWEEN;
                case Depositary.sqlEnum.OperandEnum.Equal:
                    return _EQUAL;
                case Depositary.sqlEnum.OperandEnum.GreaterThan:
                    return _GREATER_THAN;
                case Depositary.sqlEnum.OperandEnum.GreaterThanOrEqual:
                    return _GREATER_THAN_OR_EQUAL;
                case Depositary.sqlEnum.OperandEnum.In:
                    return _IN_;
                case Depositary.sqlEnum.OperandEnum.IsNotNull:
                    return _IS_NOT_NULL;
                case Depositary.sqlEnum.OperandEnum.IsNull:
                    return _IS_NULL;
                case Depositary.sqlEnum.OperandEnum.LessThan:
                    return _LESS_THAN;
                case Depositary.sqlEnum.OperandEnum.LessThanOrEqual:
                    return _LESS_THAN_OR_EQUAL;
                case Depositary.sqlEnum.OperandEnum.Like:
                    return _LIKE;
                case Depositary.sqlEnum.OperandEnum.NotEqual:
                    return _NOT_EQUAL;
                case Depositary.sqlEnum.OperandEnum.NotIn:
                    return _NOT_IN;
                case Depositary.sqlEnum.OperandEnum.NotLike:
                    return _NOT_LIKE;
            }
            return null;
        }
...
public  class AggregateParameterBase
{
    ...
    protected string GetOperand(Depositary.sqlEnum.FunctionEnum Operand)
    {
        try
        {
            switch (Operand)
            {
                case Depositary.sqlEnum.FunctionEnum.Avg:
                    return _AVG;
                case Depositary.sqlEnum.FunctionEnum.Count:
                    return _COUNT;
                case Depositary.sqlEnum.FunctionEnum.Max:
                    return _MAX;
                case Depositary.sqlEnum.FunctionEnum.Min:
                    return _MIN;
                case Depositary.sqlEnum.FunctionEnum.StdDev:
                    return _STDEV;
                case Depositary.sqlEnum.FunctionEnum.Sum:
                    return _SUM;
                case Depositary.sqlEnum.FunctionEnum.Var:
                    return _VAR;
            }
            return null;
        }
...
public class WhereParameter : WhereParameterBase
{
    ...
    internal void Add(String column, Depositary.sqlEnum.OperandEnum operand, dynamic values)
    {
    ...
    internal void Add(Depositary.sqlEnum.ConjunctionEnum Conjunction, String column, Depositary.sqlEnum.OperandEnum operand, dynamic values)
    {
        string operandString = base.GetOperand(operand);
        List<ParameterItemValue> _values = new List<ParameterItemValue>();
        try
        {
            ...
            switch (operand)
            {
                ...
                case Depositary.sqlEnum.OperandEnum.NotIn:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(Depositary.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " (" + _buff.Substring(0, _buff.Length - 1) + ")", column, operandString, column, _values));
                    break;
                case Depositary.sqlEnum.OperandEnum.IsNull:
                case Depositary.sqlEnum.OperandEnum.IsNotNull:
                    _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(Depositary.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString, column, operandString, column, _values));
                    break;
                default:
                      if( _buff.Length > 0)
                         _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(Depositary.sqlEnum.ConjunctionEnum), Conjunction) + " " + column + " " + operandString + " " + _buff.Substring(0, _buff.Length - 1), column, operandString, column, _values));
    ...
    internal void Add(Depositary.sqlEnum.ConjunctionEnum Conjunction, String betweenColumn, object fromValue, object toValue)
    {
        ...
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + firstParameter, fromValue));
        _values.Add(new ParameterItemValue(Constants.INPUT_PARAMETER + secondParameter, toValue));
        _whereParameters.Add(new ParameterItem(" " + Enum.GetName(typeof(Depositary.sqlEnum.ConjunctionEnum), Conjunction) + " " + betweenColumn + " BETWEEN " + Constants.INPUT_PARAMETER + firstParameter + " AND " + Constants.INPUT_PARAMETER + secondParameter, betweenColumn, "Between", betweenColumn, _values));
        }
        else
        {
...
{
    internal void Add(String Column, Depositary.sqlEnum.DirEnum Direction = Depositary.sqlEnum.DirEnum.ASC)
    {
        try
        {
            base._orderByParameters.Add(new ParameterItem(Column + " " + Enum.GetName(typeof(Depositary.sqlEnum.DirEnum), Direction)));
        }
        catch (Exception ex)
        {
            throw ex;
...
{
    internal void Add(Depositary.sqlEnum.FunctionEnum AggregateFunction, String Column)
    {
        try
        {
