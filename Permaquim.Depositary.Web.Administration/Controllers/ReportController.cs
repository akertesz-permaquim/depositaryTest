    ...
    public static class ReportController
    {
        ...
        public static List<DirectorioEntities.Empresa> ObtenerListadoEmpresasPorPerfil(Int64 pUsuarioId, bool filtroAscendente = false)
        {
            ...
            if (perfilVisualizacion != null)
            {
                ...
                using (Depositary.Business.Relations.Visualizacion.Perfil oPerfil = new())
                {
                    ...
                    if (oPerfil.Result.Count > 0)
                    {
                        ...
                        using (Depositary.Business.Relations.Directorio.Empresa oEmpresa = new())
                        {
                            ...
                            using (Depositary.Business.Tables.Visualizacion.PerfilTipo oPerfilTipo = new())
                            {
                                ...
                                using (Depositary.Business.Tables.Visualizacion.PerfilItem oPerfilItem = new())
                                {
                                    ...
                                    if (filtroAscendente)
                                    {
                                        switch (tipoPerfilId)
                                        {
                                            ...
                                            case (Int64)VisualizacionEntities.TipoPerfil.Sucursal:
                                                ...
                                                {
                                                    using (Depositary.Business.Relations.Directorio.Sucursal oSucursal = new())
                                                    {
                                            ...
                                            case (Int64)VisualizacionEntities.TipoPerfil.Sector:
                                                ...
                                                {
                                                    using (Depositary.Business.Relations.Directorio.Sector oSector = new())
                                                    {
                                    ...
                                    if (filtroAscendente)
                                    {
                                        switch (tipoPerfilId)
                                        {
                                            ...
                                            case (Int64)VisualizacionEntities.TipoPerfil.Sucursal:
                                                ...
                                                if (listadoSucursalesId.Count > 0)
                                                {
                                                    using (Depositary.Business.Relations.Directorio.Sucursal oSucursalListado = new())
                                                    {
                                ...
                                using (Depositary.Business.Tables.Visualizacion.PerfilItem oPerfilItem = new())
                                {
                                    ...
                                    switch (tipoPerfilId)
                                    {
                                        ...
                                        case 4://4=Sector
                                            ...
                                            if (listadoSectoresId.Count > 0)
                                            {
                                                using (Depositary.Business.Relations.Directorio.Sector oSectorPerfil = new())
                                                {
        ...
        public static List<SeguridadEntities.Usuario> ObtenerUsuarios(bool obtenerSoloHabilitados = true)
        {
            ...
            using (Depositary.Business.Tables.Seguridad.Usuario oUsuario = new())
            {
        ...
        public static List<TurnoEntities.TurnoComboReporte> ObtenerTurnos()
        {
            ...
            using (Depositary.Business.Relations.Turno.EsquemaTurno oEsquemaTurno = new())
            {
                oEsquemaTurno.Items();
        ...
        public static List<Entities.Origen> ObtenerOrigenes(bool obtenerSoloHabilitados = true)
        {
            ...
            using (Depositary.Business.Tables.Valor.OrigenValor oOrigenValor = new())
            {
                if (obtenerSoloHabilitados)
            ...
            if (perfilVisualizacion != null)
            {
                ...
                using (Depositary.Business.Relations.Visualizacion.Perfil oPerfil = new())
                {
                    ...
                    if (oPerfil.Result.Count > 0)
                    {
                        ...
                        using (Depositary.Business.Relations.Dispositivo.Depositario oDepositario = new())
                        {
