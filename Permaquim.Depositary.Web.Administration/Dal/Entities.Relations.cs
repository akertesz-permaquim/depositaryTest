...
using System.Text;
		...
		namespace Permaquim.Depositary.Entities.Relations.Sincronizacion {
			...
			public class EntidadCabecera : IRelationsDataITem
			{
                ...
                public  EntidadCabecera(Permaquim.Depositary.Entities.Relations.Customizador.Entidad EntidadId,Permaquim.Depositary.Entities.Relations.Dispositivo.Depositario DepositarioId,String Valor,DateTime Fechainicio,DateTime? Fechafin)
                {
                    this.Id = Id;
                    this.EntidadId = EntidadId;
                    this.DepositarioId = DepositarioId;
